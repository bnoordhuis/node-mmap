#ifndef MMAP_BUFFER_H_
#define MMAP_BUFFER_H_
...
class MmapBuffer : public ObjectWrap {
 public:
  ~MmapBuffer();

  static void Initialize(v8::Handle<v8::Object> target);
  static MmapBuffer* New(size_t size, int protection, int flags, int fd, off_t offset); // public constructor
 ...
 private:
  ...
  MmapBuffer(size_t size, int protection, int flags, int fd, off_t offset);
  MmapBuffer(MmapBuffer *parent, size_t start, size_t end);
